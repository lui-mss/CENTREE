...
arbi_healthcare = Offer.create!(user: arbi, category: health_care, name: "Cultural Health Navigators", phone: "999-999-9999", website: "chn.health.care", upvotes: (10..100).to_a.sample, country: "Italy", city: "Palermo", description: "We are an office dedicated to addressing the unique healthcare needs of immigrants by providing culturally sensitive support and guidance. Through language interpretation services and assistance with navigating the healthcare system, we ensure that immigrant communities receive equitable and accessible healthcare.")
alex_healthcare = Offer.create!(user: alex, category: health_care, name: "Migrant Health Clinic", phone: "888-888-8888", website: "mhc.health.care", upvotes: (10..100).to_a.sample, country: "Germany", city: "Berlin", description: "We focus on delivering comprehensive healthcare services to migrant populations, recognizing and addressing the specific health challenges faced by individuals on the move. By offering mobile clinics and culturally competent healthcare professionals, we aim to overcome barriers to healthcare access, promoting the well-being of migrant communities and contributing to their successful integration into the local health system.")
andre_healthcare = Offer.create!(user: andre, category: health_care, name: "Immigrant Mental Health Services", phone: "777-777-7777", website: "imhs.health.care", upvotes: (10..100).to_a.sample, country: "Netherlands", city: "Amsterdam", description: "We prioritize the mental well-being of immigrant populations, acknowledging the unique stressors and challenges they may encounter. Through culturally informed therapy, support groups, and outreach initiatives, this office strives to provide a safe space for immigrants to address mental health concerns, fostering resilience and promoting a holistic approach to healthcare within diverse immigrant communities.")
